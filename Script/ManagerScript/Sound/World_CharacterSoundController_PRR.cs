...
public class World_CharacterSoundController_PRR : MonoBehaviour
{
    [Header("====== 애니메이션 변수 ======")]
    [SerializeField] private PackageManager.PpororoCollection e_Character = PackageManager.PpororoCollection.NumOf;
    ...
    private void OnEnable()
    {
        ...
        e_Character = (PackageManager.PpororoCollection)System.Enum.Parse(typeof(PackageManager.PpororoCollection), gameObject.name);
